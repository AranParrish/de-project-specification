...
def conversion_for_dim_counterparty(ad_file, cp_file):
    ...
    ad_df.rename(columns={'counterparty_legal_address_id': 'legal_address_id', 'counterparty_legal_phone': 'counterparty_legal_phone_number'}, inplace = True)
...
def conversion_for_dim_date(sales_order_file):
    ...
    agreed_delivery_date_df = date_helper(agreed_delivery_date_df, "agreed_delivery_date")
